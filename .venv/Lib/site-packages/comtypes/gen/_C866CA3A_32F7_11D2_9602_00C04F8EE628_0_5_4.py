...
__all__ = [
    'ISpeechPhraseInfo', 'STSF_FlagCreate', 'DISPID_SOTSetId',
    'Speech_Max_Word_Length', 'DISPID_SpeechLexicon',
    'IEnumSpObjectTokens', 'SpeechRuleState',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPPConfidence',
    'DISPID_SWFEChannels', 'DISPID_SpeechPhraseBuilder',
    'SPFM_OPEN_READONLY', 'SDTPronunciation', 'SpeechLoadOption',
    'SPRS_INACTIVE', 'SPEI_START_INPUT_STREAM', 'SpInProcRecoContext',
    'SpLexicon', 'SREAdaptation', 'SpeechTokenKeyUI', 'SRERequestUI',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechAudioFormat', 'DISPID_SPPsCount', 'SpObjectTokenCategory',
    'SREPrivate', 'DISPID_SPIProperties', 'SpeechDataKeyLocation',
    'SAFT22kHz16BitMono', 'SAFTCCITT_ALaw_11kHzStereo',
    'STCRemoteServer', 'SpVoice', 'DISPID_SRGSetTextSelection',
    'DISPID_SpeechRecognizer', 'SPAS_STOP', 'SGPronounciation',
    'DISPID_SRState', 'eLEXTYPE_PRIVATE16',
    'SWPUnknownWordUnpronounceable', 'ISpRecognizer2',
    'DISPID_SLAddPronunciation', 'SPBINARYGRAMMAR',
    'eLEXTYPE_PRIVATE8', 'ISpRecognizer', 'DISPID_SRCRetainedAudio',
    'DISPID_SGRSTText', 'DISPID_SOTDataKey', 'ISpXMLRecoResult',
    'DISPID_SpeechAudio', 'SASPause', 'SP_VISEME_0',
    'ISpeechMemoryStream', 'SPWORDTYPE', 'DISPID_SVEViseme',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SRAONone',
    'DISPID_SVSLastBookmark', 'DISPID_SRCRetainedAudioFormat',
    'SPAUDIOOPTIONS', 'ISpeechPhraseAlternates', 'eLEXTYPE_PRIVATE4',
    'DISPID_SGRSTPropertyId', 'SpeechPartOfSpeech',
    'SpeechUserTraining', 'SAFTADPCM_44kHzMono',
    ...
    'DISPID_SRRPhraseInfo', 'tagSPTEXTSELECTIONINFO', 'WAVEFORMATEX',
    'DISPID_SpeechPhraseInfo', 'DISPID_SVWaitUntilDone',
    'ISpeechGrammarRules', 'DISPID_SpeechPhraseElements',
    'SpTextSelectionInformation', 'SPCT_DICTATION',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SVSLastBookmarkId', 'DISPID_SOTGetStorageFileName',
    'SITooSlow', 'DISPID_SCSBaseStream', 'DISPID_SpeechVoice',
    'SVP_10', 'SPEI_TTS_BOOKMARK', 'SpeechPropertyAdaptationOn',
    'SVF_None', 'SPPHRASE', 'DISPID_SRGCmdLoadFromFile',
    'SP_VISEME_4', 'SPVISEMES', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SVResume', 'STSF_AppData', 'SpeechCategoryAppLexicons',
    'SAFTExtendedAudioFormat', 'DISPID_SOTRemoveStorageFileName',
    'SVSFParseSapi', 'DISPID_SRRTStreamTime', 'DISPID_SLWsCount',
    'SPINTERFERENCE_TOOFAST', 'SPINTERFERENCE_TOOQUIET',
    'SAFT11kHz8BitStereo', 'SAFTNonStandardFormat', 'DISPID_SLWWord',
    'DISPID_SMSSetData', 'SPCS_DISABLED', 'DISPID_SpeechAudioFormat',
    'SPVPRIORITY', 'DISPID_SRCEEnginePrivate',
    ...
    'ISpeechObjectTokens', 'SPAS_CLOSED', 'SPSHT_OTHER',
    'ISpeechPhraseInfoBuilder',
    'DISPID_SpeechGrammarRuleStateTransitions', 'tagSTATSTG',
    'DISPID_SGRsFindRule', 'DISPID_SpeechRecoResult', 'SpStream',
    'ISpeechResourceLoader', 'DISPID_SGRsItem',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRCESoundStart', 'SPPS_LMA',
    'ISpNotifyTranslator', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SPPEngineConfidence', 'ISpeechLexicon', 'SPGRAMMARSTATE',
    'DISPID_SVAlertBoundary', 'SPPS_SuppressWord', 'SREBookmark',
    'DISPID_SRSClsidEngine', 'SAFTDefault', 'DISPID_SOTs_NewEnum',
    'DISPID_SPRulesItem', 'SVP_0', 'SPLEXICONTYPE', 'SPSModifier',
    'SPLO_STATIC', 'DISPID_SRGId', 'DISPID_SPIAudioStreamPosition',
    'SWTAdded', 'DISPID_SPEDisplayAttributes', 'SPAUDIOBUFFERINFO',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SPRsCount',
    'DISPID_SLPPhoneIds', 'SVEBookmark', 'DISPID_SAFGuid',
    'SpeechTokenKeyAttributes', 'SRSEDone', 'ISpRecoGrammar2',
    'SPVPRI_NORMAL', 'SpeechRuleAttributes', 'IStream',
    'eLEXTYPE_USER', 'SpResourceManager', 'ISpeechLexiconWords',
    'DISPID_SGRInitialState', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SOTCSetId', 'SWPUnknownWordPronounceable',
    'ISpeechXMLRecoResult', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPIGrammarId', 'ISpeechLexiconPronunciation',
    'DISPIDSPTSI_SelectionOffset', 'ISpPhoneticAlphabetSelection',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SGRSTransitions',
    'DISPID_SVAudioOutputStream', 'DISPID_SRSetPropertyString',
    'SLTApp', 'SpeechInterference', 'DISPID_SOTGetAttribute',
    'SAFT16kHz16BitStereo', 'ISpResourceManager', 'SRTAutopause',
    'SpeechAllElements', 'SPDKL_CurrentUser', 'SRTEmulated',
    'DISPID_SPRText', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SLPLangId',
    'SVP_19', 'SPPROPERTYINFO', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechMemoryStream', 'DISPID_SRCVoice',
    'SGLexicalNoSpecialChars', 'SPSHT_Unknown', 'SDKLCurrentConfig',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SLPPartOfSpeech',
    'ISpeechObjectToken', 'DISPID_SpeechGrammarRuleStateTransition',
    'SVP_15', 'SPSSuppressWord', 'SPBO_PAUSE', 'eLEXTYPE_PRIVATE17',
    'SVSFIsFilename', 'SRADefaultToActive', 'SP_VISEME_7',
    'SPAUDIOSTATE', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SpeechWaveFormatEx', 'SAFT12kHz8BitMono',
    'ISequentialStream', 'SP_VISEME_16', 'SpeechCategoryRecognizers',
    'DISPID_SOTsCount', 'SGDSActive', 'DISPID_SOTDisplayUI',
    'SpeechLexiconType', 'eLEXTYPE_RESERVED7', 'SVP_21',
    'SPVPRI_OVER', 'SREPropertyNumChange', 'DISPID_SRRRecoContext',
    'DISPID_SBSSeek', 'ISpeechDataKey', 'SPEI_HYPOTHESIS',
    'SpeechAddRemoveWord', 'DISPID_SpeechPhraseAlternate', 'UINT_PTR',
    'SRTExtendableParse', 'DISPID_SRRTTickCount', 'SPPS_RESERVED2',
    'DISPID_SGRSAddRuleTransition', 'SVPOver',
    'DISPID_SASCurrentSeekPosition', 'SAFTCCITT_ALaw_22kHzStereo',
    'SSFMOpenReadWrite', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRIsShared', 'DISPID_SRCEPhraseStart',
    'eLEXTYPE_PRIVATE12', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SPPParent', 'SDTReplacement', 'ISpVoice',
    'DISPID_SPPsItem', 'SPEVENTSOURCEINFO',
    'DISPID_SRGetPropertyString', 'SVF_Emphasis', 'SGLexical',
    'SP_VISEME_3', 'eLEXTYPE_PRIVATE1', 'DISPID_SRCBookmark',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPRsItem',
    'DISPID_SVESentenceBoundary', 'SPINTERFERENCE_NOISE', 'STCAll',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVSLastResult',
    'SSSPTRelativeToEnd', 'SpeechPropertyResponseSpeed',
    'SpeechGrammarWordType', 'SPPS_Interjection',
    'SPEI_END_SR_STREAM', 'SPEI_MAX_SR',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SPEPronunciation', 'STCInprocServer', 'SSFMCreate',
    'SPDKL_DefaultLocation', 'DISPID_SpeechFileStream',
    'SpeechMicTraining', 'DISPID_SDKEnumKeys', 'SRADynamic',
    'eLEXTYPE_USER_SHORTCUT', 'ISpEventSource', 'SGRSTTRule',
    'SPSHORTCUTPAIRLIST', 'DISPIDSPTSI', 'DISPID_SRRTimes',
    'SPEI_VISEME', 'DISPID_SGRSTs_NewEnum', 'ISpAudio',
    'SPEI_VOICE_CHANGE', 'DISPID_SOTGetDescription', 'ISpLexicon',
    'DISPID_SRCEHypothesis', 'DISPID_SLWType', 'SPXRO_SML',
    'DISPID_SPRuleName', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SPAs_NewEnum', 'SPRST_INACTIVE',
    'DISPID_SpeechRecoContext', 'DISPID_SOTRemove',
    'DISPID_SRCERecognition', 'DISPID_SPRuleId',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPIEngineId',
    'DISPID_SDKSetLongValue', 'SGRSTTTextBuffer', 'DISPID_SASState',
    ...
    'SVSFUnusedFlags', 'ISpeechRecoResultDispatch',
    'DISPID_SWFEFormatTag', 'SAFTNoAssignedFormat', 'SDTLexicalForm',
    'Speech_Max_Pron_Length', 'SAFTCCITT_ALaw_44kHzMono',
    ...
    'DISPID_SVSPhonemeId', 'DISPID_SRCPause', 'ISpeechLexiconWord',
    'DISPID_SDKDeleteValue', 'DISPID_SASNonBlockingIO',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRCreateRecoContext',
    'DISPID_SpeechPhraseRules', 'DISPID_SVGetProfiles',
    'SDKLDefaultLocation', 'SpeechRunState',
    'DISPID_SRCCreateGrammar', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SVAudioOutput', 'SPINTERFERENCE', 'SpeechTokenContext',
    'DISPID_SDKGetlongValue', 'SAFTGSM610_8kHzMono',
    'SPEI_WORD_BOUNDARY', 'SRCS_Disabled', 'DISPID_SDKCreateKey',
    'DISPID_SWFEBlockAlign', 'DISPID_SVPause', 'SGRSTTEpsilon',
    'SpMemoryStream', 'SITooLoud', 'SPSMF_UPS',
    'SPINTERFERENCE_TOOSLOW', 'SpMMAudioOut', 'eLEXTYPE_PRIVATE3',
    'LONG_PTR', 'ISpRecoGrammar', 'DISPID_SRCEEndStream',
    'eLEXTYPE_RESERVED10', 'SAFT12kHz8BitStereo',
    'SpNullPhoneConverter', 'SpCustomStream', 'ISpDataKey',
    'SpeechPropertyResourceUsage', 'SP_VISEME_6', 'SpeechAudioVolume',
    'SREPropertyStringChange', 'SpeechCategoryRecoProfiles',
    'SP_VISEME_11', 'SpeechStreamSeekPositionType', 'SVSFIsXML',
    'DISPID_SPIReplacements', 'DISPID_SOTCGetDataKey',
    'SPCT_SUB_COMMAND', 'SPSHORTCUTPAIR', 'SPPS_Modifier',
    'DISPID_SBSRead', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRCEStartStream', 'SP_VISEME_2',
    'ISpPhoneticAlphabetConverter', 'eLEXTYPE_APP',
    'DISPID_SpeechMMSysAudio', 'SPSHT_NotOverriden', 'SDTRule',
    'SECHighConfidence', 'ISpPhraseAlt', 'DISPID_SPIRule',
    'DISPID_SASCurrentDevicePosition', 'SpeechCategoryVoices',
    'DISPID_SLPsCount', 'SECFIgnoreCase', 'SPPS_Verb',
    'SpeechGrammarState', 'SPSLMA', 'SPFM_CREATE',
    'SpeechDictationTopicSpelling', 'DISPID_SGRsCommit',
    'SPEI_ADAPTATION', 'DISPID_SRDisplayUI', 'ISpeechPhraseRules',
    'DISPID_SRCEBookmark', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpRecoResult', 'DISPID_SRRAlternates', 'DISPID_SVSkip',
    'SAFT24kHz16BitMono', 'SPBOOKMARKOPTIONS', 'SRSActiveAlways',
    'SSTTWildcard', 'SpeechWordPronounceable', 'SPBO_AHEAD',
    'DISPID_SGRName', 'DISPID_SGRAddState', 'DISPID_SRRAudio',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRCRequestedUIType', 'DISPID_SPIElements',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRProfile', 'SP_VISEME_21',
    'SPAUDIOSTATUS', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SPARecoResult', 'SFTInput', 'DISPID_SBSWrite',
    'SVPNormal', 'DISPID_SPRNumberOfElements', 'SPEI_INTERFERENCE',
    'DISPID_SpeechObjectToken', 'SPEI_TTS_PRIVATE', 'ISpRecognizer3',
    'DISPID_SRSNumberOfActiveRules', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SASFreeBufferSpace', 'SPXRO_Alternates_SML',
    'DISPID_SGRsDynamic', 'SpeechTokenShellFolder', 'SPSHORTCUTTYPE',
    'ISpeechGrammarRuleStateTransitions', 'SpeechGrammarTagWildcard',
    'DISPID_SABufferInfo', 'SITooQuiet', 'DISPID_SGRSTsCount',
    'SPAR_Unknown', 'DISPID_SPRFirstElement', 'SP_VISEME_10',
    'SpAudioFormat', 'SRAExport', 'DISPID_SRCEAdaptation',
    'SRERecognition', 'DISPID_SRSetPropertyNumber',
    'DISPID_SpeechLexiconWord', 'SPEI_SR_PRIVATE', 'ISpShortcut',
    'SAFTGSM610_44kHzMono', 'SPBO_NONE', 'SPPHRASEREPLACEMENT',
    'DISPID_SOTIsUISupported', 'ISpeechRecoResultTimes',
    'SpWaveFormatEx', 'SINoSignal', 'SPAO_RETAIN_AUDIO',
    'SPSERIALIZEDRESULT', 'DISPID_SASetState', 'DISPID_SVSVisemeId',
    'DISPID_SRGetPropertyNumber', 'SPCT_SUB_DICTATION',
    'SPCONTEXTSTATE', 'DISPID_SMSGetData', 'SpSharedRecoContext',
    'SpeechRecoEvents', 'SPRECOCONTEXTSTATUS',
    'DISPID_SVIsUISupported', '_RemotableHandle',
    'ISpeechPhraseAlternate', 'SpObjectToken', 'SPINTERFERENCE_NONE',
    'DISPID_SVSpeakStream', 'SSSPTRelativeToStart', 'SPPS_Noun',
    'SPTEXTSELECTIONINFO', 'SAFTCCITT_uLaw_22kHzMono', 'SPEI_MIN_SR',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SFSClose', 'SP_VISEME_15',
    'SDTAudio', 'DISPID_SRGRules', 'DISPID_SRCEAudioLevel',
    'SpeechCategoryAudioOut', 'DISPID_SPIEnginePrivateData',
    'SPSInterjection', 'SAFT22kHz8BitMono', 'SPVPRI_ALERT',
    'DISPID_SRCCreateResultFromMemory', 'eLEXTYPE_PRIVATE19',
    'ISpeechFileStream', 'SPSMF_SAPI_PROPERTIES', 'SREStreamStart',
    'DISPID_SRGDictationLoad', 'SpeechDiscardType',
    'DISPID_SVPriority', 'DISPID_SBSFormat', 'SPEI_PHONEME',
    'DISPID_SDKOpenKey', 'DISPID_SRCEFalseRecognition',
    'DISPID_SGRSTPropertyValue', 'DISPID_SVRate',
    'DISPID_SGRsCommitAndSave', 'SPEI_RESERVED2', 'SRSEIsSpeaking',
    'DISPID_SRGReset', 'SVSFParseSsml', 'SDA_No_Trailing_Space',
    'SpMMAudioEnum', 'SVEPhoneme', 'SPCATEGORYTYPE', 'SRAImport',
    'ISpeechVoice', 'DISPID_SAStatus', 'SpeechVisemeType', 'SAFTText',
    'DISPID_SRIsUISupported', 'ISpeechRecoGrammar', 'SVP_2',
    'eLEXTYPE_PRIVATE20', 'DISPID_SVSInputSentenceLength',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPRDisplayAttributes',
    'DISPID_SLWsItem', 'DISPID_SAVolume', 'DISPID_SLWLangId',
    ...
    'DISPID_SABufferNotifySize', 'SPFILEMODE', 'SLTUser',
    ...
    'SpInprocRecognizer', 'SAFTGSM610_11kHzMono', 'DISPID_SGRSTType',
    'eLEXTYPE_VENDORLEXICON', 'ISpeechPhraseReplacements',
    'ISpeechGrammarRule', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SAFType', 'SpeechRegistryUserRoot', 'eLEXTYPE_RESERVED4',
    'SECFDefault', 'SPEI_SR_AUDIO_LEVEL', 'SAFTADPCM_11kHzStereo',
    'SBOPause', 'SpeechTokenKeyFiles', 'DISPID_SpeechPhraseRule',
    'SPWT_DISPLAY', 'SPWF_SRENGINE', 'SAFT44kHz16BitStereo',
    'SpeechEngineProperties', 'DISPID_SRRecognizer',
    'DISPID_SPAsCount', 'DISPID_SOTCategory', 'SPEI_RESERVED1',
    'eLEXTYPE_RESERVED9', 'SP_VISEME_17',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPPName',
    'DISPID_SRGDictationUnload', 'SPRS_ACTIVE_USER_DELIMITED',
    'SP_VISEME_8', 'ISpeechRecognizerStatus',
    'DISPID_SABIMinNotification', 'SSTTTextBuffer', 'SPSNoun',
    ...
    'SECFIgnoreKanaType', 'ISpeechRecoContext', 'DISPID_SRRTLength',
    'SpeechEngineConfidence', 'SPEI_PHRASE_START',
    'eLEXTYPE_PRIVATE10', 'DISPID_SWFEBitsPerSample',
    'STCInprocHandler', 'SPSEMANTICERRORINFO', 'SPLO_DYNAMIC',
    'SREAllEvents', 'DISPID_SPAsItem', 'DISPID_SRCERequestUI',
    'ISpeechCustomStream', 'eLEXTYPE_PRIVATE13',
    'SAFTTrueSpeech_8kHz1BitMono', 'SVP_17', 'DISPID_SPAPhraseInfo',
    'DISPID_SGRSTWeight', 'DISPID_SpeechLexiconWords',
    'SAFTADPCM_22kHzMono', 'SVEAllEvents', 'SAFT16kHz8BitStereo',
    'DISPID_SOTsItem', 'eLEXTYPE_PRIVATE5', 'SVP_11', 'SBONone',
    'DISPID_SPEDisplayText', 'ISpeechPhraseReplacement',
    'ISpeechRecoResult', 'SDTDisplayText', 'SVP_13',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SGDSActiveWithAutoPause', 'DISPID_SRRSaveToMemory',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPACommit',
    'DISPID_SRSAudioStatus', 'DISPID_SRAudioInputStream',
    'SpeechRecognitionType', 'DISPID_SVEStreamEnd',
    'DISPID_SDKDeleteKey', 'SAFT16kHz16BitMono',
    'SGDSActiveUserDelimited', 'SVP_12', 'SPSEMANTICFORMAT',
    'DISPID_SpeechXMLRecoResult', 'ISpRecoContext2',
    'DISPID_SVSpeakCompleteEvent', 'SAFT12kHz16BitStereo',
    'DISPID_SRGDictationSetState', 'SVP_6', 'SAFT11kHz16BitMono',
    'DISPID_SRCSetAdaptationData', 'SASStop',
    'SAFTCCITT_ALaw_8kHzMono', 'SP_VISEME_9', 'ISpPhoneConverter',
    'DISPID_SOTCreateInstance', 'SAFTCCITT_uLaw_22kHzStereo',
    'SRESoundStart', 'ISpeechMMSysAudio',
    'DISPID_SpeechPhraseProperty', 'SAFT16kHz8BitMono',
    'SREStreamEnd', 'SPAR_High', 'SWTDeleted',
    'SpeechSpecialTransitionType', 'SP_VISEME_1',
    'SpeechRetainedAudioOptions', 'SPINTERFERENCE_TOOLOUD', 'SINoise',
    'SpeechRecoProfileProperties', 'DISPID_SRCState', 'SPEI_MAX_TTS',
    'SDTAll', 'SECFEmulateResult', 'DISPID_SGRSAddSpecialTransition',
    ...
    'DISPID_SRRGetXMLErrorInfo', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'eLEXTYPE_PRIVATE11', 'SVEPrivate', 'DISPID_SVVoice',
    'SPLOADOPTIONS', 'DISPID_SGRs_NewEnum', 'SPRECOSTATE',
    'DISPID_SPPValue', 'SITooFast', 'SAFT48kHz8BitMono',
    'SVSFVoiceMask', 'DISPID_SPEsCount', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SVVolume', 'SPGS_EXCLUSIVE', 'DISPID_SOTId',
    ...
    'SPDATAKEYLOCATION', 'DISPID_SGRId', 'SPGS_ENABLED',
    'SECLowConfidence', 'SPEI_REQUEST_UI', 'eWORDTYPE_ADDED',
    'SPDKL_CurrentConfig', 'SVEAudioLevel',
    'DISPID_SREmulateRecognition', 'SRARoot', 'eLEXTYPE_RESERVED6',
    'SAFT44kHz16BitMono', 'DISPID_SpeechLexiconProns',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCEventInterests',
    'DISPID_SPAStartElementInResult', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SPIRetainedSizeBytes', 'SVSFIsNotXML', 'SRSInactive',
    'SVP_18', 'DISPID_SRGIsPronounceable', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechEmulationCompareFlags', 'DISPID_SGRClear',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPIAudioSizeBytes', 'SVP_14',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechGrammarTagDictation', 'DISPID_SVEPhoneme', 'SPRST_ACTIVE',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRSSupportedLanguages', 'SPGS_DISABLED', 'SP_VISEME_5',
    'SGRSTTWildcard', 'eLEXTYPE_PRIVATE14', '_SPAUDIOSTATE',
    'SAFT32kHz16BitMono', 'DISPID_SpeechVoiceStatus', 'SPWT_LEXICAL',
    'SpeechVoiceEvents', 'DISPIDSPRG', 'DISPID_SGRAttributes',
    'ISpGrammarBuilder', 'SpeechTokenValueCLSID', 'SPPS_Function',
    'DISPID_SOTCEnumerateTokens', 'ISpNotifySink',
    'SVESentenceBoundary', 'DISPID_SPIAudioSizeTime',
    'SPWORDPRONUNCIATION', 'SPSHT_EMAIL', 'SLODynamic',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SABIBufferSize', 'DISPID_SPPNumberOfElements',
    'IInternetSecurityManager', 'SVP_8', 'SpStreamFormatConverter',
    'DISPID_SRRSpeakAudio', 'DISPID_SpeechPhraseReplacement',
    'SRTStandard', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRGSetWordSequenceData', 'SDTAlternates',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechPropertyComplexResponseSpeed', 'SP_VISEME_20',
    'SpMMAudioIn', '__MIDL_IWinTypes_0009', 'SAFT48kHz16BitStereo',
    'DISPID_SpeechPhraseElement', 'SREFalseRecognition', 'SRTReSent',
    'ISpRecoCategory', 'SVPAlert', 'SPSVerb', 'SP_VISEME_13',
    'DISPID_SABIEventBias', 'DISPID_SLPSymbolic',
    'DISPID_SVSInputWordLength', 'SVSFNLPMask', 'DISPID_SLGetWords',
    'ISpObjectTokenCategory', 'SGRSTTDictation',
    'SAFT24kHz16BitStereo', 'SPEI_SOUND_START', 'SPAS_RUN',
    'DISPID_SRCResume', 'DISPID_SGRsAdd', 'SPWORD', 'SVSFlagsAsync',
    'SVP_9', 'DISPID_SpeechAudioStatus', 'SECNormalConfidence',
    'DISPID_SPEsItem', 'SPPS_Noncontent', 'SDKLCurrentUser',
    'DISPID_SPCLangId', 'eLEXTYPE_PRIVATE7', 'DISPID_SRCRecognizer',
    '_ISpeechRecoContextEvents', 'DISPID_SMSALineId',
    'SAFT8kHz8BitStereo', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRStatus', 'DISPID_SVGetVoices',
    'DISPID_SpeechVoiceEvent', 'SAFT32kHz16BitStereo',
    'SPFM_OPEN_READWRITE', 'STSF_CommonAppData',
    'SpeechAudioFormatType', 'SPEI_PROPERTY_STRING_CHANGE',
    'SRAInterpreter', 'ISpeechPhraseElement', 'SPSTREAMFORMATTYPE',
    'SVEViseme', 'SVSFPersistXML', 'DISPID_SRGetFormat',
    'SPFM_NUM_MODES', 'ISpeechRecoResult2', 'DISPID_SOTCDefault',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SPIGetText',
    'DISPID_SVSRunningState', 'eLEXTYPE_RESERVED8',
    'SpeechRecognizerState', 'SpeechPropertyHighConfidenceThreshold',
    'SpeechVisemeFeature', 'ISpNotifySource', 'ISpRecoContext',
    'SGSExclusive', 'SpeechFormatType', 'SPAR_Medium', 'SP_VISEME_12',
    'DISPID_SPRulesCount', 'DISPID_SVSpeak', 'SPWAVEFORMATTYPE',
    'ISpeechPhraseProperty', 'DISPID_SWFEAvgBytesPerSec',
    'SAFTADPCM_8kHzMono', 'DISPID_SPPId',
    'DISPID_SOTMatchesAttributes', 'DISPID_SVEStreamStart',
    'DISPID_SRGCmdSetRuleIdState', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPAO_NONE', 'SASClosed', 'SPGRAMMARWORDTYPE',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVStatus',
    'SAFT22kHz16BitStereo', 'SPEI_START_SR_STREAM',
    'Speech_Default_Weight', 'SREAudioLevel', 'STSF_LocalAppData',
    'eLEXTYPE_PRIVATE18', 'SAFT44kHz8BitMono', 'SVEEndInputStream',
    'SPPHRASERULE', 'DISPID_SLPType', 'DISPID_SADefaultFormat',
    'SVSFParseAutodetect', 'DISPID_SDKGetStringValue',
    'SpeechAudioState', 'SPEI_SENTENCE_BOUNDARY', 'SREInterference',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SGRSTPropertyName',
    'SpeechVoiceSpeakFlags', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPCS_ENABLED', 'IEnumString', 'SAFT8kHz16BitMono',
    'ISpeechObjectTokenCategory', 'SAFTGSM610_22kHzMono',
    'DISPID_SPISaveToMemory', 'SVP_5', 'SpeechBookmarkOptions',
    'SpFileStream', 'SpPhoneticAlphabetConverter',
    'ISpStreamFormatConverter', 'SREHypothesis',
    'DISPID_SDKSetStringValue', 'DISPID_SLPsItem', 'SPRS_ACTIVE',
    'SPSUnknown', 'SPSERIALIZEDPHRASE', 'SPEI_TTS_AUDIO_LEVEL',
    'SPBO_TIME_UNITS', 'SVEStartInputStream', 'SAFT22kHz8BitStereo',
    'SVSFDefault', 'ISpeechAudioBufferInfo', 'SPWT_PRONUNCIATION',
    'SPEI_SOUND_END', 'SDTProperty', 'ISpeechAudio',
    'SPRECORESULTTIMES', 'IInternetSecurityMgrSite', 'SPPARTOFSPEECH',
    'SP_VISEME_19', 'DISPIDSPTSI_ActiveLength', 'SPPS_RESERVED3',
    'DISPID_SMSAMMHandle', 'SpShortcut', 'DISPID_SVEWord',
    'SPSFunction', 'DISPID_SGRSTsItem', 'ISpObjectWithToken',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SVDisplayUI',
    'SSFMOpenForRead', 'DISPID_SpeechDataKey', 'SRESoundEnd',
    '_ISpeechVoiceEvents', 'DISPID_SLGetPronunciations',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpEventSink',
    'DISPID_SLGenerationId', 'DISPID_SVEAudioLevel',
    'DISPID_SWFESamplesPerSec', 'SPRST_NUM_STATES',
    'DISPID_SDKEnumValues', 'DISPID_SPEAudioStreamOffset',
    'SpNotifyTranslator', 'ISpMMSysAudio', 'SVEVoiceChange',
    'SAFT8kHz16BitStereo', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRGRecoContext', 'DISPID_SPRuleConfidence',
    'SPWORDPRONOUNCEABLE', 'SpeechAudioProperties', 'SVP_1',
    'ISpeechPhraseProperties', 'DISPID_SRRGetXMLResult',
    'DISPID_SVEventInterests', 'SPEI_MIN_TTS',
    'ISpeechPhoneConverter', 'DISPID_SPPChildren', 'SVF_Stressed',
    'SPRECOGNIZERSTATUS', 'SPEI_UNDEFINED',
    'SpeechCategoryPhoneConverters', 'SPEI_RESERVED3',
    'SPEI_RESERVED6', 'SAFTCCITT_ALaw_8kHzStereo',
    'SRSInactiveWithPurge', 'SPINTERFERENCE_NOSIGNAL',
    'SPPHRASEPROPERTY', 'DISPID_SDKGetBinaryValue', 'SRAORetainAudio',
    'DISPID_SRGState', 'SGRSTTWord', 'ISpeechLexiconPronunciations',
    'SAFT8kHz8BitMono', 'SGSDisabled',
    'SSSPTRelativeToCurrentPosition', 'SRTSMLTimeout', 'SVP_7',
    'ISpeechPhraseRule', 'SAFT48kHz8BitStereo',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SPEs_NewEnum', 'SRSActive',
    'SAFT24kHz8BitMono', 'ISpeechRecognizer', 'STCLocalServer',
    'SREStateChange', 'SDA_One_Trailing_Space', 'SPFM_CREATE_ALWAYS',
    'DISPID_SPRuleChildren', 'DISPID_SpeechPhraseProperties', 'SVP_3',
    'DISPID_SpeechPhraseReplacements', 'Speech_StreamPos_RealTime',
    'SGSEnabled', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPRules_NewEnum', 'DISPID_SPCIdToPhone',
    'SPEI_RECOGNITION', 'SAFT11kHz16BitStereo',
    'SPADAPTATIONRELEVANCE', 'SECFNoSpecialChars', 'SPRULESTATE',
    'SDKLLocalMachine', 'SPEI_SR_BOOKMARK', 'SPRULE',
    'DISPID_SGRSTNextState', 'DISPID_SPPs_NewEnum', 'SpeechWordType',
    'SpeechAudioFormatGUIDText', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SVSCurrentStreamNumber', 'SPEI_RESERVED5',
    'SpeechAudioFormatGUIDWave', 'SpUnCompressedLexicon', 'SVP_20',
    'ISpObjectToken', 'SPSNotOverriden', 'SRATopLevel',
    'DISPID_SPEAudioSizeTime', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPELexicalForm',
    'DISPID_SLWs_NewEnum', 'DISPID_SPCPhoneToId', 'ISpStream',
    'SPWF_INPUT', 'SpeechPropertyNormalConfidenceThreshold',
    'SpPhoneConverter', 'DISPID_SPRuleNumberOfElements',
    'ISpProperties', 'SPPS_RESERVED1', 'SVEWordBoundary',
    'SFTSREngine', 'DISPID_SPEActualConfidence', 'SGDisplay',
    'DISPID_SpeechGrammarRule', 'SPVOICESTATUS',
    'SAFT32kHz8BitStereo', 'DISPID_SAEventHandle',
    'SpeechStreamFileMode', 'tagSPPROPERTYINFO', 'DISPID_SGRsCount',
    'SPPS_NotOverriden', 'SINone', 'DISPID_SRCEInterference',
    'ISpSerializeState', 'DISPID_SPERequiredConfidence',
    'DISPID_SPERetainedSizeBytes', 'SPDKL_LocalMachine', 'SVP_4',
    'SVP_16', 'DISPID_SPRuleEngineConfidence', 'DISPID_SWFEExtraData',
    'SGDSInactive', 'SASRun', 'SPCT_SLEEP', 'SECFIgnoreWidth',
    'ISpeechBaseStream', 'SpPhraseInfoBuilder', 'DISPID_SVEBookmark',
    'SpeechVoiceSkipTypeSentence', 'SDA_Two_Trailing_Spaces',
    'ISpPhrase', 'SRCS_Enabled', 'DISPID_SRCCmdMaxAlternates',
    'SpeechVoicePriority', 'SPEVENT', 'eWORDTYPE_DELETED',
    'SAFT11kHz8BitMono', 'DISPID_SRCEPropertyStringChange',
    'SPEI_FALSE_RECOGNITION', 'SSFMCreateForWrite', 'SPWORDLIST',
    'DISPID_SOTCId', 'DISPID_SLRemovePronunciation',
    'DISPID_SVEEnginePrivate', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SGRAddResource', 'SSTTDictation', 'DISPID_SGRSRule',
    'DISPID_SGRSTRule', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRGetRecognizers', 'DISPID_SRAudioInput',
    'SRERecoOtherContext', 'SpeechCategoryAudioIn', 'SPAR_Low',
    'SP_VISEME_18', 'SPPS_Unknown', 'eLEXTYPE_PRIVATE2',
    'DISPID_SpeechRecoResult2', 'SPCT_COMMAND', 'DISPID_SLPs_NewEnum',
    'SP_VISEME_14', 'SAFT12kHz16BitMono', 'DISPID_SMSADeviceId',
    'ISpeechAudioStatus', 'ISpeechVoiceStatus',
    'DISPID_SpeechBaseStream'
]

_check_version('1.2.0', 1617976235.338093)
